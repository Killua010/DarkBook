package br.com.darkbook.endereco.controller;
...
public class PaisController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		JSONObject paisesJson = new JSONObject();
		...
		for(Entidade entidade :  paisList) {
			...
			paisesJson.put("paises", paisJson);
		...
		response.getWriter().write(paisesJson.toString());
